...
export default function AddBrewingDeviceForm({ userId, onDeviceAdded }: Props) {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      setFormError(
        err instanceof Error ? err.message : "Failed to add brewing device"
      );
    } finally {
  ...
  if (isLoading) {
    return (
      <div className="text-center">Loading available brewing devices...</div>
    );
  }
