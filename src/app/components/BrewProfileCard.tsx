    ...
    >
      <div className="p-5">
        ...
        <div className="grid grid-cols-2 gap-x-4 gap-y-2 mb-4">
          <div>
            <p className="text-xs text-gray-500 coffee:text-gray-400">Device</p>
            <p className="text-sm">{profile.brewDevice?.name || "Unknown"}</p>
          </div>
          <div>
            <p className="text-xs text-gray-500 coffee:text-gray-400">Ratio</p>
            <p className="text-sm">{profile.ratio}</p>
          </div>
          {profile.roastLevel && (
            <div>
              <p className="text-xs text-gray-500 coffee:text-gray-400">Roast Level</p>
              <p className="text-sm">{profile.roastLevel}</p>
            </div>
          )}
          {profile.process && (
            <div>
              <p className="text-xs text-gray-500 coffee:text-gray-400">Process</p>
